...
使用`ESM`标准的**Node/Koa/TS**项目脚手架，内置包含了：

1. 接口定义 & 路由使用
2. 数据库链接使用
3. 中间件使用
4. `token`鉴权处理
5. 项目热更新、容器部署配置、以及环境配置使用

- 旧版实现/介绍请移步到[掘金介绍](https://juejin.cn/post/6844903922767757320/)
- 当前项目模板中，用户相关功能需要依赖带数据库链接操作，具体参考[配置数据库](https://juejin.cn/post/6844903922767757320/#heading-3)
...
- **2026-05-20** 新增`crypto`加密操作，配对前端的传输处理。
- **2026-05-13** 去掉自定义`jwt`功能模块，改用更容易维护的查库处理。
- **2026-04-22** 新增`@antfu/eslint-config`作为项目格式化工程。
